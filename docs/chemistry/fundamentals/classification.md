...
| | 划分角度 | 是否带电 | 能否独立存在 | 例子 |
|---|---|---|---|---|
| 基 | 电子状态（带单电子） | 电中性 | 不能，只在分子中 | $\ce{-CH3}$、$\ce{-CH2-}$、$\ce{-OH}$ |
| 官能团 | 功能（决定特性） | 电中性 | 不能 | $\ce{-OH}$、$\ce{-CHO}$、$\ce{-COOH}$ |
| 原子团 | 组成（多原子集团） | **可带电** | 带电时能（即离子） | $\ce{SO4^2-}$、$\ce{NH4+}$、$\ce{OH-}$ |
...
- **显色反应**（化）：如苯酚遇 $\ce{FeCl3}$ 显紫色、淀粉遇 $\ce{I2}$ 变蓝。
- **颜色反应**（化）：如蛋白质遇浓硝酸变黄。
- **指示剂变色**（化）：指示剂与 H⁺/OH⁻ 作用结构改变而变色，如酚酞遇碱变红。

### 五解

- **潮解**（物）：晶体吸收空气中水分而溶解，如 $\ce{NaOH}$、$\ce{CaCl2}$，本质是溶解。
- **分解**（化）：一种物质生成多种物质，如 $\ce{CaCO3}$ 高温分解。
...
- **氢化 / 油脂的硬化**：与 $\ce{H2}$ 加成，如油酸甘油酯硬化成人造脂肪。
- **氧化**：失电子（加氧去氢）的反应。
- **水化**：与水反应，如 $\ce{CuSO4 + 5H2O -> CuSO4.5H2O}$、乙烯水化制乙醇。
- **风化**：结晶水合物在干燥空气中失水，如 $\ce{Na2CO3.10H2O -> Na2CO3}$。
- **炭化**：浓硫酸按水的比例夺走有机物中 H、O，留下碳。
- **钝化**：浓硫酸/浓硝酸使 Fe、Al 表面生成致密氧化膜。
- **催化**：催化剂参与并改变化学反应速率的过程。
- **皂化**：油脂在碱性条件下水解生成肥皂（高级脂肪酸盐）。
- **歧化**：同一物质既被氧化又被还原，如 $\ce{Cl2 + 2NaOH -> NaCl + NaClO + H2O}$。
